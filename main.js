...
var randomNumber = Math.floor((Math.random() * data_set.length) + 1)
console.log(data_set[randomNumber])
var sketchToBeDrawn = data_set[randomNumber]
document.getElementById("draw").innerHTML = "Sketch To Be Drawn: " + sketchToBeDrawn
timer_count = 0
timer_check = ""
drawn_sketch = ""
answer_holder = ""
